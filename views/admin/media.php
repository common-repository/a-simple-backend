<li class="menu-item-page menu-item-edit-inactive pending">
    <dl class="menu-item-bar">
        <dt class="menu-item-handle">
            ...
            <span class="item-controls">
                <span class="item-type">Media</span>
    ...
    <div class="menu-item-settings menu-item-settings-wide">
        <div class="menu-item-actions description-wide submitbox">
            <p class="link-to-original">Original: <a href="<?php echo $this->sanitize_link($link, 'media'); ?>"><?php echo $orig; ?></a></p>
            ...
            <input type="hidden" name="<?php echo $this -> pre; ?>menu[<?php echo $index; ?>][type]" value="media" />
