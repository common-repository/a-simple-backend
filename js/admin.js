(function($) {
    ...
    $(document).ready(function() {
        ...
        var settings = $(".asimplebackend-settings"),
            export_import = $(".asimplebackend-export-import", settings),
            export_import_form = $(".asimplebackend-export-import-form", settings),
            blogging_post = $('#asimplebackend-plugins-wp-blogging, #asimplebackend-plugins-wp-post'),
            cb_wrapper = $('.asimplebackend-cb-wrapper');
        ...
        blogging_post.on('change', function() {
            if(this.checked) {
                blogging_post.not(this).prop('checked', false);
            } else {
                blogging_post.not(this).prop('checked', true);
            }
        });
        ...
        if(cb_wrapper.length) {
            var _resize_title = function() {
                var w = cb_wrapper.outerWidth(true),
                    input = $('#titlediv #titlewrap #title');

                input.css({
                    width: ''
                });

                if(cb_wrapper.css('display') == 'inline-block') {
                    input.css({
                        width: input.width() - w
                    });
                }
            ...
            cb_wrapper.appendTo('#titlediv #titlewrap');
