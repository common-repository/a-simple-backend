(function($) {
    var menu = function() {
        ...
        $(".asimplebackend-settings .item-edit").live(window.interact.touchEnd, function(e) {
            e.preventDefault();
            var that = $(this);
        ...
        $(".asimplebackend-settings .item-cancel").live(window.interact.touchEnd, function(e) {
            e.preventDefault();
            var that = $(this);
            var parent = that.parents("li");
            var settings = $(".menu-item-settings", parent);
        ...
        $(".asimplebackend-settings .item-delete").live(window.interact.touchEnd, function(e) {
            e.preventDefault();
            var that = $(this);
            var parent = that.parents("li");
        ...
        $(".asimplebackend-settings .edit-menu-item-title").live('focus', function() {
            var that = $(this);
